                                            ...
                                            <div class="px-4 py-5 bg-white sm:p-6">
                                                ...
                                                <div class="col-span-6">
                                                    ...
                                                    <select name="parent_id" id="" required="required"
                                                        ...
                                                        @if($sub_department->isNotEmpty())
                                                            @foreach($sub_department as $dep)
                                                                <option value="{{$dep->parent_id}}" @if($subdepartment->parent_id == $dep->parent_id) selected @endif >{{$dep->name}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
