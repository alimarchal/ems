                                                ...
                                                <div class="grid grid-cols-6 gap-6">
                                                    <div class="col-span-6">
                                                        ...
                                                        <input type="text" name="permission_name" id="permission_name"
                                                               value="{{$permission->name}}" autocomplete="permission_name"
                                                               required="required"
                                                               class="border-gray-300 @error('permission_name') border-red-500 @enderror mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm  rounded-md">
                                                        @error('permission_name')<span
